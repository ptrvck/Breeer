 ...
 */
public class ClusteringAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    private static final int DEFAULT_MAX_DISTANCE_AT_ZOOM = 70; // essentially 100 dp.
